            ...
            <div class="container">
                <nav class="collapse navbar-collapse navbar-right" role="navigation">
                    <ul id="nav" class="nav navbar-nav">
                        ...
                        <li><a href="#testimonials">Leyes y prohibiciones</a></li>
                        <li><a href="#price">Entrenamiento</a></li>
                        <li><a href="#nada">Administrar cuentas</a></li>
                    </ul>
                </nav>
            </div>
        </header>
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="sec-title text-center">
							<h2 class="wow">Zona de rutas</h2>
							<p class="wow">En proceso</p>
						</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="sec-title text-center wow animated fadeInDown">
							...
							<p>Estas son algunas de las fotos de las rutas y excursiones de la web</p>
						</div>
